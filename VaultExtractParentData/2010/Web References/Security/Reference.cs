...
namespace VaultExtractParentData.Security {
    ...
    public partial class SecurityService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public AccessPermisAndGrp EndGetAllAccessPermissionsAndGroups(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((AccessPermisAndGrp)(results[0]));
        }
        ...
        /// <remarks/>
        public ACL EndUpdateACLEntries(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((ACL)(results[0]));
        }
